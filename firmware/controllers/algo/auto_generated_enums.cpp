...
// on Tue Apr 28 16:35:41 CEST 2020
...
const char *getAntiLagAirSupply_e(antiLagAirSupply_e value){
switch(value) {
case E_THROTTLE:
  return "E_THROTTLE";
case Force_4bytes_size_antiLagAirSupply_e:
  return "Force_4bytes_size_antiLagAirSupply_e";
case IDLE_VALVE:
  return "IDLE_VALVE";
case SOLENOID:
  return "SOLENOID";
...
const char *getGpPwmBelowAbove_e(gpPwmBelowAbove_e value){
switch(value) {
case ABOVE:
  return "ABOVE";
case BELOW:
  return "BELOW";
case Force_4bytes_size_gpPwmBelowAbove_e:
  return "Force_4bytes_size_gpPwmBelowAbove_e";
  }
 return NULL;
}
const char *getGpPwmChannel_e(gpPwmChannel_e value){
switch(value) {
case COOLANT:
  return "COOLANT";
case Force_4bytes_size_gpPwmChannel_e:
  return "Force_4bytes_size_gpPwmChannel_e";
case MAP:
  return "MAP";
case NONE:
  return "NONE";
...
const char *getLoadAxis_e(loadAxis_e value){
switch(value) {
case Force_4bytes_size_loadAxis_e:
  return "Force_4bytes_size_loadAxis_e";
case LOAD_CLT:
  return "LOAD_CLT";
case LOAD_MAP:
  return "LOAD_MAP";
...
switch(value) {
case Force_4bytes_size_vvtLoadAxis_e:
  return "Force_4bytes_size_vvtLoadAxis_e";
case VVT_LOAD_CLT:
  return "VVT_LOAD_CLT";
case VVT_LOAD_MAP:
  return "VVT_LOAD_MAP";
...
switch(value) {
case CLOSED_LOOP_VVT:
  return "CLOSED_LOOP_VVT";
case Force_4bytes_size_vvtType_e:
  return "Force_4bytes_size_vvtType_e";
case ON_OFF_VVT:
  return "ON_OFF_VVT";
  }
 return NULL;
