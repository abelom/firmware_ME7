...
void EnginePins::unregisterPins() {
	...
	unregisterOutputIfPinOrModeChanged(cj125Mode, cj125ModePin, cj125ModePinMode);
	unregisterOutputIfPinOrModeChanged(gp1Pin, gpPwm[0].io.gpPwmPin, gpPwm[0].io.gpPwmPinMode);
	unregisterOutputIfPinOrModeChanged(gp2Pin, gpPwm[1].io.gpPwmPin, gpPwm[1].io.gpPwmPinMode);
	unregisterOutputIfPinOrModeChanged(gp3Pin, gpPwm[2].io.gpPwmPin, gpPwm[2].io.gpPwmPinMode);
	unregisterOutputIfPinOrModeChanged(gp4Pin, gpPwm[3].io.gpPwmPin, gpPwm[3].io.gpPwmPinMode);
	unregisterOutputIfPinOrModeChanged(vvtPin, vvt.vvtControlPin, vvt.vvtControlPinMode)
