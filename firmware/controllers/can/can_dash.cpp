...
#define CAN_VAG_ESP 0x1A0
#define CAN_VAG_RPM 0x280
#define CAN_VAG_CLT 0x288
#define CAN_VAG_CLT_V2 0x420
#define CAN_VAG_IMMO 0x3D0
#define CAN_VAG_SPEED 0x2A8 // 996 - Motorsteuerger t 680 - engine control unit Speed (78270+(47907*kmh))/1000
//#define SPEED 0x351
//w202 DASH
...
#define hi8(x) ((int)(x)>>8);
		...
		int rawSpeed = getVehicleSpeed();

		int speed = rawSpeed / 0.0075;  //KMH=1.12 MPH=0.62
		speedL = lo8(speed);
		speedH = hi8(speed);

		CanTxMessage msg(CAN_VAG_ESP);
				msg[0] = 0x18;
				msg[1] = speedL; //Speed Lowbyte
				msg[2] = speedH; //Speed Highbyte
				msg[3] = 0x00;
				msg[4] = 0xfe;
				msg[5] = 0xfe;
				msg[6] = 0x00;
